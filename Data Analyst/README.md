...
This level only has the lessons of Object Oriented Programming  (OOP) which is necessary for Data Analyst and Scientist. The remaining concepts of OOP are in another level. 
...
Sometimes data are not stored in a relational database, however it stored in files with specific formats like xml, json and so on. Data analysts are expected to be able to handle such files.
## Technologies series
One of the following courses is enough. These are the programs that help you in your work with less programming. I will not recored these courses but will give you links to courses in English to be ready to be professional. 
